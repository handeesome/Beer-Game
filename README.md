...
We added the [signup-custom.html](SE/templates/signup_custom.html) and the [custom_login.html](SE/templates/custom_login.html) file to allow students to either sign up or log in (if they have already registered) and make a custom game. 
